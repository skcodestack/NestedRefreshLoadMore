...
public class NestedRecyclerViewFragment extends Fragment implements onLoadMoreListener, onRefreshListener {
    ...
    public static NestedRecyclerViewFragment newInstance(boolean isFollow) {
        NestedRecyclerViewFragment f = new NestedRecyclerViewFragment();
        f.isFollow = isFollow;
        return f;
    }
    @Override
