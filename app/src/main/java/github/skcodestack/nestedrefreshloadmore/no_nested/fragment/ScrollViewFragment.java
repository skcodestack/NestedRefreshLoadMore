...
public class ScrollViewFragment extends Fragment implements onLoadMoreListener, onRefreshListener {
    ...
    public static ScrollViewFragment newInstance(boolean isFollow) {
